...
const Community = () => {
  ...
  return (
    <div className="p-6 pt-12 xl:px-12 w-full mx-auto h-full overflow-y-scroll">
        ...
        {images.map((item,index)=>(
          <a href={item.imageUrl} target="_blank" 
           ...
           className="relative group block rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow duration-300 " >
            <img src={item.imageUrl} className="w-full h-10 md:h-50 2xl:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out" alt="" />
